...
import EventflitOptions from './options';
import UrlStore from 'core/utils/url_store';

export default class Eventflit {

  /*  STATIC PROPERTIES */
  static instances : Eventflit[]  = [];
  ...
  constructor(app_key : string, options : any) {
    ...
    this.key = app_key;
    this.config = Collections.extend<EventflitOptions>(
  ...
  bind(event_name : string, callback : Function, context? : any) : Eventflit {
    this.global_emitter.bind(event_name, callback, context);
    return this;
  }

  unbind(event_name? : string, callback? : Function, context? : any) : Eventflit {
    this.global_emitter.unbind(event_name, callback, context);
    return this;
  }

  bind_global(callback : Function) : Eventflit {
    this.global_emitter.bind_global(callback);
    return this;
  }

  unbind_global(callback? : Function) : Eventflit {
    this.global_emitter.unbind_global(callback);
    return this;
  }

  unbind_all(callback? : Function) : Eventflit {
