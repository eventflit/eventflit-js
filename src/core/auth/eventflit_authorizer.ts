...
export default class EventflitAuthorizer implements Authorizer {
  ...
  authorize(socketId : string, callback : Function) : any {
    EventflitAuthorizer.authorizers = EventflitAuthorizer.authorizers || Runtime.getAuthorizers();
    return EventflitAuthorizer.authorizers[this.type].call(this, Runtime, socketId, callback);
  }
}
