...
/**
 * Provides functions for handling Eventflit protocol-specific messages.
 */

/**
 * Decodes a message in a Eventflit format.
 *
 ...
 * connection attempt, when eventflit:connection_established is received, which
 * results in a 'connected' action with an 'id' property. When passed a
 * eventflit:error event, it returns a result with action appropriate to the
 ...
 * 2. http://eventflit.com/docs/pusher_protocol
 *
