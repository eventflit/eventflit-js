...
/** Manages connection to Eventflit.
 *
 ...
 * - pongTimeout - time for Eventflit to respond with pong before reconnecting
 *
...
export default class ConnectionManager extends EventsDispatcher {
  ...
  /** Establishes a connection to Eventflit.
   *
  ...
  private buildConnectionCallbacks() : ConnectionCallbacks {
    return {
      ...
      ping: ()=> {
        this.send_event('eventflit:pong', {});
      },
      activity: ()=> {
        this.resetActivityCheck();
      },
