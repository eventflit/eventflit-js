...
var Mocks = {
  ...
  getEventflit: function(config) {
    var eventflit = new EventsDispatcher();
    eventflit.config = config;
    eventflit.unsubscribe = jasmine.createSpy("unsubscribe");
    eventflit.send_event = jasmine.createSpy("send_event");
    return eventflit;
  },
