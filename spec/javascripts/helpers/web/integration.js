...
exports.API_URL = "http://eventflit-js-integration-api.herokuapp.com";
exports.API_EU_URL = "http://eventflit-js-integration-api-eu.herokuapp.com";
...
exports.sendAPIMessage = function(request) {
  var Eventflit = window.Eventflit;
  var jsonpRequest = new JSONPRequest(request.url, {
    channel: request.channel,
    event: request.event,
    data: request.data
  });
  var receiver = Eventflit.Integration.ScriptReceivers.create(function() {
    Eventflit.Integration.ScriptReceivers.remove(receiver);
  });
